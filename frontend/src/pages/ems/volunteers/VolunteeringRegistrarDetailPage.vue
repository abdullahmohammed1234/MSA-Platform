...
const handleDelete = async () => {
  ...
  try {
    ...
    void router.push({ name: 'ems-volunteering-registrars' });
  } catch (err: any) {
...
<template>
  <div class="space-y-8 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <EmsPageHeader
      title="Volunteer Registration Detail"
      description="Review application information, update status, and manage private administrative notes."
      backTo="/ems/volunteering-registrars"
    />
