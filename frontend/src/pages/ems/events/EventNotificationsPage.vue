    ...
    <template v-else-if="summary">
      ...
      <section v-if="tab === 'history'" class="mt-8 space-y-6">
        ...
        <div class="block md:hidden space-y-3">
          <div v-if="notifications.length === 0" class="p-6 text-center text-neutral-muted bg-white rounded-2xl border border-neutral-ivory">
            ...
            <div class="flex items-start justify-between gap-2">
              <div>
                ...
                <p class="text-xs text-neutral-muted">
                  Ref: {{ row.registration?.reference || row.registration?.attendee_name || '—' }}
                </p>
              </div>
