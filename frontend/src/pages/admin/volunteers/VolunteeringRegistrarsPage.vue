...
<template>
  <div class="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Admin Header -->
    <div class="space-y-1">
      <h1 class="text-3xl font-display font-bold text-neutral-black tracking-tight">Volunteering Registrars</h1>
      <p class="text-sm text-neutral-muted">Manage, review, and track public volunteer registrations for SFU MSA.</p>
    </div>
