...
const getModuleBadgeClass = (module: string) => {
  const mapping: Record<string, string> = {
    ...
    Donations: 'bg-teal-500/10 text-teal-600 border border-teal-500/20',
    Sponsorship: 'bg-cyan-500/10 text-cyan-600 border border-cyan-500/20',
    SPMS: 'bg-cyan-500/10 text-cyan-600 border border-cyan-500/20',
    Notifications: 'bg-sky-500/10 text-sky-600 border border-sky-500/20',
