...
const hasAnyAccess = computed(() => access.hasCmsAccess);
...
<template>
  <div class="mx-auto flex min-h-[60vh] max-w-lg flex-col items-center justify-center text-center">
    ...
    <p v-if="!hasAnyAccess" class="mt-2 text-sm text-neutral-muted">
      Your account does not have access to the Content Management System. Ask an MSA administrator to
      assign you a CMS role.
    </p>
    ...
    <div class="mt-6 flex flex-wrap justify-center gap-2">
      <Button v-if="hasAnyAccess" variant="primary" @click="$router.push({ name: 'cms-dashboard' })">
        Go to dashboard
      </Button>
