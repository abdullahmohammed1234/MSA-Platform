      ...
      <ScrollReveal direction="up" :distance="50" width="100%">
        <div class="bg-primary py-24 md:py-32 px-6 md:px-12 rounded-[3rem] md:rounded-[4rem] relative overflow-hidden group border border-secondary/10 shadow-premium max-w-6xl mx-auto">
          ...
          <div class="relative z-10 text-center space-y-8 max-w-4xl mx-auto">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4 w-full max-w-md sm:max-w-lg mx-auto pt-4 px-4">
              ...
              <router-link to="/contact" class="w-full sm:flex-1">
                <PublicButton variant="outline" size="lg" class="border-white/20 text-white hover:bg-white/10 w-full font-bold">
                  Contact Chaplain
                </PublicButton>
              </router-link>
            </div>
