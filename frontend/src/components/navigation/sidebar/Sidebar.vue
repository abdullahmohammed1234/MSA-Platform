  ...
  <div class="relative shrink-0">
    ...
    >
      <div class="flex flex-col flex-1 overflow-y-auto">
        ...
        <div
          :class="[
            'border-b border-neutral-ivory/50 shrink-0 flex items-center justify-between',
            isCollapsed
        ...
        >
          ...
          <button
            ...
            :class="[
              'hidden lg:flex rounded-lg hover:bg-neutral-background text-neutral-muted hover:text-primary transition-colors cursor-pointer shrink-0',
              isCollapsed ? 'p-2 w-full justify-center' : 'p-1.5'
            ]"
