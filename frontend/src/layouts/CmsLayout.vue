...
const cmsItems = computed(() => {
  ...
  if (isSuper || cmsAccess.permissions.includes('manage_homepage') || cmsAccess.permissions.includes('manage_resources')) {
    children.push({ label: 'Prayer & Jumu\'ah', path: '/cms/prayers', icon: 'clock' });
  }
    ...
    <div class="flex-1 flex flex-col min-w-0">
      <header class="h-16 border-b border-neutral-ivory bg-white flex items-center justify-between px-4 sm:px-6 shrink-0">
        <div class="flex items-center min-w-0">
          ...
          <div class="min-w-0">
            <p class="text-[10px] font-black uppercase tracking-widest text-primary/60 truncate">Content Management System</p>
